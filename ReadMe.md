...
Form validation is for to make sure the information that the user is filling the form is valid, correct, or is what the form expects to have it. If you fill the wrong information, wil trow a error to letting you know that is wrong.

3. In 1-2 sentences, define end to end testing.

End to End Testing, or UI testing is one the many approaches for testing a web application.
An end to end test is supposed to check whether a web application works as expected or not, by testing the so called user flow.
